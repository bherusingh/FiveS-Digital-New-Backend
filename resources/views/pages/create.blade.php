...
<link rel='stylesheet' href='../nestable/nestable.css'/>
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('page.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
				...
				<div class="row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-group{{ $errors->has('meta_keywords') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('meta_keywords') ? ' is-invalid' : '' }}" name="meta_keywords" id="input-meta_keywords" type="text" placeholder="{{ __('Meta Keywords') }}" value="{{ old('meta_keywords') }}" required="true" aria-required="true"/>
				...
				<div class="row">
					...
					<div class="col-sm-10">
					  <div class="form-group{{ $errors->has('meta_desc') ? ' has-danger' : '' }}">
						<input class="form-control{{ $errors->has('meta_desc') ? ' is-invalid' : '' }}" name="meta_desc" id="input-meta_desc" type="text" placeholder="{{ __('Meta Description') }}" value="{{ old('meta_desc') }}" required="true" aria-required="true"/>
