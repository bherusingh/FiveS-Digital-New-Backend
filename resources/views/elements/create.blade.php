...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('element.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Add Element') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <label class="col-sm-5 col-form-label">{{ __('Name of the element') }}</label>
                  <div class="col-sm-7">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-primary">{{ __('Add Element') }}</button>
              </div>
            </div>
          </form>
        </div>
