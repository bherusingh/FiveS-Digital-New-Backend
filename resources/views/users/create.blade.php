                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('display_name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('display_name') ? ' is-invalid' : '' }}" name="display_name" id="input-display_name" type="text" placeholder="{{ __('Display Name') }}" value="{{ old('display_name') }}" required="true" aria-required="true"/>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('mobile') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" name="mobile" id="input-mobile" type="text" placeholder="{{ __('Mobile') }}" value="{{ old('mobile') }}" required />
               ...
               <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('role') ? ' has-danger' : '' }}">
                      <select class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" name="role" id="input-role"   placeholder="{{ __('Role') }}" value="{{ old('role') }}" required>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"   type="password" name="password" id="input-password" placeholder="{{ __('Password') }}" value="" required />
               ...
               <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('force_change_pwd') ? ' has-danger' : '' }}">
                      <input class="form-check-input{{ $errors->has('force_change_pwd') ? ' is-invalid' : '' }}" type="checkbox" name="force_change_pwd" value="1" {{ (is_array(old('force_change_pwd')) && in_array(1, old('force_change_pwd'))) ? ' checked' : '' }}  /> <label  >{{ __('Force Change Password on Next Login') }}</label>
